...
WebUI.mouseOver(findTestObject('Object Repository/Page_Battleground  MaxQuest/div_COMING SOON_mq-slider-arrow arrow-left _6f3ef8'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Battleground  MaxQuest/h3_Instructions  Rules'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Battleground  MaxQuest/div_How to play      Compete in a room made_9806f2'))
