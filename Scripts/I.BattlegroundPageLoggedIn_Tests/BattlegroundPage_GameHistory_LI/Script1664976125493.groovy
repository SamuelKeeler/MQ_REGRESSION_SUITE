...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Battleground  MaxQuest/span_GAME HISTORY'), 0)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Battleground  MaxQuest/span_GAME HISTORY'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Battleground  MaxQuest/span_GAME HISTORY'))

WebUI.mouseOver(findTestObject('Object Repository/Page_Battleground  MaxQuest/span_GAME HISTORY'))

WebUI.click(findTestObject('Object Repository/Page_Battleground  MaxQuest/span_GAME HISTORY'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Battleground  MaxQuest/div_GAME            BUY-IN            POSIT_5408da'), 
    0)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Battleground  MaxQuest/div_GAME            BUY-IN            POSIT_5408da'))
